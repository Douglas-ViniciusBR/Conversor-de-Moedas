...
moeda_origem = input("Qual é a origem da moeda? EX: BRL, USD, EUR e etc..):") .upper() 
converter = input("Deseja converter pra qual moeda?") .upper()
...
if moeda_origem in taxas and converter in taxas:
    ...
    print("Moeda inválida. Porque favor, tente novamente.")